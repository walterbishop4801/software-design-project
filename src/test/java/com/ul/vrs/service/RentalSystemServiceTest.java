...
public class RentalSystemServiceTest {
    ...
    public void testCustomizeBooking_Success() {
        ...
        Optional<Booking> customizedBooking = rentalSystemService.customizeBooking(bookingId, mockCustomization);

        assertNotNull(customizedBooking, "Customized booking should not be null"); // Ensure customization worked
        assertEquals(bookingId, customizedBooking.get().getBookingId(), "Booking ID should remain the same after customization");
    }
