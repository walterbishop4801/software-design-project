...
public class CustomerTest {
	...
	public void testSearchAvailableVehicles() {
	    ...
	    vehicles.get(0).updateState(VehicleState.AVAILABLE);
	    vehicles.get(1).updateState(VehicleState.RESERVED);

	    Interceptor mockInterceptor = mock(Interceptor.class);
	    customer.addInterceptor(mockInterceptor);

	    // Act
	    customer.searchAvailableVehicles(vehicles);
	    ...
	    // Verify available vehicles are printed
	    assertTrue(vehicles.get(0).getState() == VehicleState.AVAILABLE);
	    assertTrue(vehicles.get(1).getState() == VehicleState.RESERVED);
	}
	...
	public void testBookVehicle() {
	    ...
	    assertEquals(VehicleState.RESERVED, vehicle.getState(), "Vehicle should be in RESERVED state after booking.");
	...
	public void testCancelBooking() {
	    ...
	    // Assert
	    assertEquals(VehicleState.AVAILABLE, vehicle.getState(), "Vehicle should be in AVAILABLE state after cancellation.");
	...
	public void testReturnVehicle() {
	    ...
	    // Assert
	    assertEquals(VehicleState.AVAILABLE, vehicle.getState(), "Vehicle should be in AVAILABLE state after returning.");
